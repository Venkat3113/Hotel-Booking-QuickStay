...
const HotelCard = ({room, index}) => {
  return (
    ...
    className="relative max-w-70 w-full rounded-xl overflow-hidden bg-white text-gray-500/90 shadow-[0px_4px_4px_rgba(0,0,0,0.05)]">
            ...
            {index % 2 === 0 && <p className='px-3 py-1 absolute top-3 left-3 text-xs bg-white text-gray-800 rounded-full shadow-md font-medium'
            >Best Seller</p>}
            <div className='p-4 pt-5'>
                ...
                <div className='flex items-center justify-between mt-4'>
                    ...
                    <button className='px-4 py-2 text-sm font-medium border-gray-300 rounded hover:bg-gray-100 transition-all cursor-pointer'
                    >Book Now</button>
                </div>
            </div>
    </Link>
